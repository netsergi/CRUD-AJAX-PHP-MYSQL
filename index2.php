			...
			<tbody>
				<?php while ($trabajador = $trabajadores->fetch())  : ?>
					<tr>
						...
						<td>
							<button type="button" id="btneliminar" data-nombre="<?php echo $trabajador['nombre'] . "  " . $trabajador['apellidos']?>" data-id="<?php echo $trabajador['id']; ?>" class="w3-button w3-red w3-round-xlarge " data-toggle="modal" data-target="#exampleModal"><b>Eliminar trabajador</b></button>
